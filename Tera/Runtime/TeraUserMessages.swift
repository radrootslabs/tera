...
enum TeraUserMessageKey: String, CaseIterable, Sendable {
  ...
  var defaultValue: String {
    ...
    case .runtimeOperationFailed:
      "The Tera runtime could not complete the operation."
    case .runtimeUnavailable:
      "The Tera runtime is unavailable."
    ...
    case .shutdownFailed:
      "Tera could not finish shutting down."
    case .startupFailed:
      "Tera could not start."
    case .todayChanged:
...
enum TeraUserMessages {
  static func text(_ key: TeraUserMessageKey, bundle: Bundle? = nil) -> String {
  ...
  static func key(
    ...
    TeraUserMessageClassifier.key(for: error, fallback: fallback)
  }
